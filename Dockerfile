...
WORKDIR /go/src/github.com/WreckingBallStudioLabs/migrate
...
COPY --from=downloader /go/src/github.com/WreckingBallStudioLabs/migrate/build/migrate.linux-386 /migrate
