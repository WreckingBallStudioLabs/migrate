...
[Release Downloads](https://github.com/WreckingBallStudioLabs/migrate/releases)

```bash
$ curl -L https://github.com/WreckingBallStudioLabs/migrate/releases/download/$version/migrate.$platform-amd64.tar.gz | tar xvz
```
...
```bash
$ go get -u -d github.com/WreckingBallStudioLabs/migrate/cmd/migrate
$ cd $GOPATH/src/github.com/WreckingBallStudioLabs/migrate/cmd/migrate
$ git checkout $TAG  # e.g. v4.1.0
$ go build -tags 'postgres' -ldflags="-X main.Version=$(git describe --tags)" -o $GOPATH/bin/migrate github.com/WreckingBallStudioLabs/migrate/cmd/migrate
```

#### Unversioned

```bash
$ go get -tags 'postgres' -u github.com/WreckingBallStudioLabs/migrate/cmd/migrate
```
...
1. Support for build constraints will be removed in the future: https://github.com/WreckingBallStudioLabs/migrate/issues/60
